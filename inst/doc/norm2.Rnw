...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{bivar-plotsbefore}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.48\textwidth]{bivar-plotNorm2-1}
\includegraphics[width=0.48\textwidth]{bivar-plotNorm2-2}
...
\begin{figure}[htp]
\centering
\includegraphics{bivar-plotafter}
